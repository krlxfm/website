    ...
    <div class="row">
        <div class="col">
            ...
            <div class="alert alert-warning">
                To avoid formatting issues, please write or transcribe answers to the editors below rather than copying and pasting. If you need to copy and paste, please <a href="https://css-tricks.com/copy-paste-the-web/#article-header-id-8" target="_blank" class="alert-link">paste without formatting</a>.
            </div>
